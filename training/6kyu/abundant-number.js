...
describe("Example Tests", function () {
    it("Simple Cases", function () {
        assert.deepEqual(abundant(15), [[12], [4]], 'Incorrect answer');
        assert.deepEqual(abundant(19), [[18], [3]], 'Incorrect answer');
        assert.deepEqual(abundant(100), [[100], [17]], 'Incorrect answer');
        assert.deepEqual(abundant(999), [[996], [360]], 'Incorrect answer');
    });
});
