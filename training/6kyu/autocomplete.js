...
describe("Solution", function () {
    it("should test for something", function () {
        assert.deepEqual(autocomplete('ai', ['airplane', 'airport', 'apple', 'ball']), ['airplane', 'airport'])
    });
    it("should test for non alphanumeric letters", function () {
        assert.deepEqual(autocomplete('ai*&r**', ['airplane', 'airport', 'apple', 'ball']), ['airplane', 'airport'])
    });
});
