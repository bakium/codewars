...
const GROUP1 = ['o', 'as', 'a', 'amos', 'áis', 'an']
const GROUP2 = ['o', 'es', 'e', 'emos', 'éis', 'en']
...
describe('Basic tests', function () {
    it('Must work with infinitive suffix -er', function () {
        assert.deepEqual(conjugate('comer'), comer)
    });
    it('Must work with infinitive suffix -er', function () {
        assert.deepEqual(conjugate('comer'), comer)
    });
    it('Must work with infinitive suffix -ir', function () {
        assert.deepEqual(conjugate('vivir'), vivir)
    });
    it('Must work with infinitive suffix -ar', function () {
        assert.deepEqual(conjugate('caminar'), caminar)
    });
})
